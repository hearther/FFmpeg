...
IJK_DUMMY_PROTOCOL(ff_mkhook_protocol1);
IJK_DUMMY_PROTOCOL(ff_mkhook_protocol2);
IJK_DUMMY_PROTOCOL(ff_mkhook_protocol3);
IJK_DUMMY_PROTOCOL(ff_mkhook_protocol4);
IJK_DUMMY_PROTOCOL(ff_mkhook_protocol5);
IJK_DUMMY_PROTOCOL(ff_mkhook_protocol6);