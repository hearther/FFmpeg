...
IJK_DUMMY_PROTOCOL(mkhook1);
IJK_DUMMY_PROTOCOL(mkhook2);
IJK_DUMMY_PROTOCOL(mkhook3);
IJK_DUMMY_PROTOCOL(mkhook4);
IJK_DUMMY_PROTOCOL(mkhook5);
IJK_DUMMY_PROTOCOL(mkhook6);
IJK_DUMMY_PROTOCOL(mkhook7);
IJK_DUMMY_PROTOCOL(mkhook8);
IJK_DUMMY_PROTOCOL(mkhook9);
IJK_DUMMY_PROTOCOL(mkhook10);